...
[TestClass]
public class TestStampData() : TestDataClass<StampData>("stamp")
{
    [TestMethod]
    public void LoadAndValidateStamp()
    {
        LoadAndValidate("stamp_image");
        LoadAndValidate("stamp_text");
        LoadAndValidate("stamp_token");
    }
    [TestMethod]
    public void MockAndValidateStamp()
    {
        for (int idx = 0; idx < 100; idx++)
        {
            Validate(MockClass.MockStampData());
        }
    }
}
